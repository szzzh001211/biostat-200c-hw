...
```{r}
mod <- lmer(narsp ~ . - msa + + (1 | msa), data = hprice)
summary(mod)
```
Coefficient for `time` = -1.265e-03. This means that the natural log of house price decreases by 0.001265 thousand dollars per year.
