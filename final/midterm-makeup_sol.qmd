...
tibble::tibble(
  ...
  Genus = c("0.05 IQR(0.03)" , "0.07 IQR(0.05)", "0.04 IQR(0.03)", "0 IQR()"),
  Species = c("0.03 IQR(0.04)", "0.07 IQR(0.05)", "0.05 IQR(0.03)", "0.04 IQR(0.03)")
)
```
...
In summary, the zero inflated poisson model is the best model for both Genus and Species level while the zero inflated negative binomial model is conservative and negative binomial is inflated.
