...
subtitle: May 16, 2024 @ 10am-11:50pm
output:
  html_document:
    toc: yes
    toc_depth: 4
...
**Answer:** False. We can also use the logistic model when some independent variables are categorical.
...
**Answer:** False. The logistic model can be applied to both prospective and retrospective (case-control) studies.
