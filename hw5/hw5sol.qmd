...
\Rightarrow \hat{\mu} &=& \frac{\sum_{ij} y_{ij}}{na}\\
\\
\\
\frac{\partial \ell}{\partial \sigma^2_\alpha} &=& \sum_{i=1}^{a} \left[ -\frac{1}{2} \text{tr}(\Omega^{-1} \frac{\partial \Omega}{\partial \sigma^2_\alpha}) + \frac{1}{2} (\mathbf{y}_i - \mu \mathbf{1}_n)^T \Omega^{-1} \frac{\partial \Omega}{\partial \sigma^2_\alpha} \Omega^{-1} (\mathbf{y}_i - \mu \mathbf{1}_n) \right] = 0 \\
\text{where } \frac{\partial \Omega}{\partial \sigma^2_\alpha} &=& 
\begin{bmatrix}
1 & 1 & \cdots & 1 \\
1 & 1 & \cdots & 1 \\
\vdots & \vdots & \ddots & \vdots \\
1 & 1 & \cdots & 1
\end{bmatrix}_{n \times n} = \mathbf{1}_n \mathbf{1}_n^T \\
\frac{\partial \ell}{\partial \sigma^2_\alpha} &=&  \sum_{i=1}^{a} \left[ -\frac{1}{2} \mathbf{1}_n^T \Omega^{-1} \mathbf{1}_n + \frac{1}{2} (\mathbf{y}_i - \mu \mathbf{1}_n)^T \Omega^{-1} \mathbf{1}_n \mathbf{1}_n^T \Omega^{-1} (\mathbf{y}_i - \mu \mathbf{1}_n) \right] = 0\\
\Omega^{-1} &=& \frac{1}{\sigma^2_\epsilon} \left( I_n - \frac{\sigma^2_\alpha}{\sigma^2_\epsilon + n \sigma^2_\alpha} J_n \right) \\
\Omega^{-1}\mathbf{1}_n &=& \frac{1}{\sigma^2_\epsilon + n \sigma^2_\alpha} \mathbf{1}_n \\
\Rightarrow \frac{\partial \ell}{\partial \sigma^2_\alpha} &=& \sum_{i=1}^{a} \left[ -\frac{1}{2} \frac{n}{\sigma^2_\epsilon + n \sigma^2_\alpha} + \frac{1}{2} \frac{\left( \sum_{j=1}^{n} (y_{ij} - \mu) \right)^2}{(\sigma^2_\epsilon + n \sigma^2_\alpha)^2} \right]=0
\\
\\
\frac{\partial \ell}{\partial \sigma^2_\epsilon} &=& \sum_{i=1}^{a} \left[ -\frac{1}{2} \text{tr}(\Omega^{-1} \frac{\partial \Omega}{\partial \sigma^2_\epsilon}) + \frac{1}{2} (\mathbf{y}_i - \mu \mathbf{1}_n)^T \Omega^{-1} \frac{\partial \Omega}{\partial \sigma^2_\epsilon} \Omega^{-1} (\mathbf{y}_i - \mu \mathbf{1}_n) \right] = 0 \\
\text{where } \frac{\partial \Omega}{\partial \sigma^2_\epsilon} &=& 
\begin{bmatrix}
1 & 0 & \cdots & 0 \\
0 & 1 & \cdots & 0 \\
\vdots & \vdots & \ddots & \vdots \\
0 & 0 & \cdots & 1
\end{bmatrix}_{n \times n} = I_n\\
\frac{\partial \ell}{\partial \sigma^2_\epsilon} &=& \sum_{i=1}^{a} \left[ -\frac{1}{2} \text{tr}(\Omega^{-1}) + \frac{1}{2} (\mathbf{y}_i - \mu \mathbf{1}_n)^T \Omega^{-1}\Omega^{-1} (\mathbf{y}_i - \mu \mathbf{1}_n) \right] = 0
