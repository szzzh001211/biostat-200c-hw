...
```
**Interpretation**: Before the binning, the plot shows a hyperbolic pattern with one asymptote at $y=0$. But after the binning, the plot shows kind of hyperbolic pattern when binned deviance residuals $>0$.
