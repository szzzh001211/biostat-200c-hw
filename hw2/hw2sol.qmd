...
lmod1 |>
  ...
  bold_p(t = 0.05)
```
**Answer:** The p-value of `spontaneous` is $<0.001$ so it is a significant predictor. Every one unit increase in the number of prior spontaneous abortions increases the odds of being an infertile case by a factor of $e^{1.2} = 3.32$, controlling for all other predictors.\
The p-value of `induced` is $0.042<0.05$ so it is also a significant predictor. Every one unit increase in the number of prior induced abortions increases the odds of being an infertile case by a factor of $e^{0.42} = 1.52$, controlling for all other predictors.
...
lmod3 |>
  ...
  bold_p(t = 0.05)
```
**Answer:** Every one unit increase in the number of prior spontaneous abortions increases the odds of being an infertile case by a factor of $e^{2} = 7.39$, controlling for all other predictors.

Every one unit increase in the number of prior induced abortions increases the odds of being an infertile case by a factor of $e^{1.3} = 3.67$, controlling for all other predictors.

Every one year increase in age increases the odds of being an infertile case by a factor of $e^{0.04} = 1.04$, controlling for all other predictors.

Every one unit increase in the number of parity decrease the odds of being an infertile case by a factor of $e^{-0.83} = 0.436$, controlling for all other predictors.

The odds of being an infertile case is estimated to decrease by a factor of $e^{-1} = 0.368$ for people with education level 6-11 years compared to people with education level 0-5 years, controlling for all other predictors.

The odds of being an infertile case is estimated to decrease by a factor of $e^{-1.4} = 0.247$ for people with education level 12+ years compared to people with education level 0-5 years, controlling for all other predictors.
...
lmod4 |>
  ...
  bold_p(t = 0.05)
```
**Answer:** The coefficients change much from the previous model. Every one unit increase in the number of prior spontaneous abortions increases the odds of being an infertile case by a factor of $e^{2} = 7.39$, controlling for all other predictors. 

Every one unit increase in the number of prior induced abortions increases the odds of being an infertile case by a factor of $e^{1.3} = 3.67$, controlling for all other predictors. 

These changes may be because case control model can control the confounding factors more effectively.
