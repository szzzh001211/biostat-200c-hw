...
lmod3 |>
  ...
  bold_p(t = 0.05)
```
**Answer:** Coefficient of `spontaneous` = $2$. Every one unit increase in the number of prior spontaneous abortions increases the odds of being an infertile case by a factor of $e^{2} = 7.39$, controlling for all other predictors.
...
Coefficient of `parity` = $-0.83$. Every one unit increase in the number of parity decrease the odds of being an infertile case by a factor of $e^{-0.83} = 0.436$, controlling for all other predictors.
...
lmod4 |>
  ...
  bold_p(t = 0.05)
```
**Answer:** The coefficients change much from the previous model. Coefficient of `spontaneous` = $2$. Every one unit increase in the number of prior spontaneous abortions increases the odds of being an infertile case by a factor of $e^{2} = 7.39$, controlling for all other predictors. 

Coefficient of `induced` = $1.3$. Every one unit increase in the number of prior induced abortions increases the odds of being an infertile case by a factor of $e^{1.3} = 3.67$, controlling for all other predictors. 

These changes may be because case control model can control the confounding factors more effectively and then the effects of spontaneous and induced abortions xxx.
