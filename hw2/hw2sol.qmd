...
```
**Answer:** There are more control cases with no spontaneous or induced abortions than the infertile cases. Both case and control groups have no observation with 2 or more spontaneous abortions and 2 or more induced abortions.
...
The odds of being a case decreases by a factor of $e^{-1} = 0.368$ for education level 6-11 years compared to education level 0-5 years, controlling for all other predictors.\
The odds of being a case decreases by a factor of $e^{-1.4} = 0.247$ for education level 12+ years compared to education level 0-5 years, controlling for all other predictors.
